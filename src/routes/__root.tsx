...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Jharva Fashion" },
      { property: "og:title", content: "Jharva Fashion — Premium & Affordable Apparel" },
      { property: "og:description", content: "Shop Jharva Fashion — Premium kurtis, tops, dresses, co-ords, and anime printed oversized tees. Enquire by style code on WhatsApp." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@jharvafashion" },
      { name: "twitter:title", content: "Jharva Fashion — Premium & Affordable Apparel" },
      { name: "twitter:description", content: "Shop Jharva Fashion — Premium kurtis, tops, dresses, co-ords, and anime printed oversized tees. Enquire by style code on WhatsApp." },
